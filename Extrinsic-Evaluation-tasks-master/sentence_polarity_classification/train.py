...
print("Dev-Accuracy mean: %.2f" % (np.mean(dev_acc)))
print("Test-Accuracy mean: %.2f" % (np.mean(test_acc)))
print("Dev-Accuracy SD: %.2f" % (np.std(dev_acc)))
print("Test-Accuracy SD: %.2f" % (np.std(test_acc)))
